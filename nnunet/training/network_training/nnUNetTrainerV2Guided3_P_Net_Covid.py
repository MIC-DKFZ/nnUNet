...
from nnunet.network_architecture.P_Net_Covid import P_Net_Covid
...
class nnUNetTrainerV2Guided3_P_Net_Covid(nnUNetTrainerV2):
    ...
    def initialize(self, training=True, force_load_plans=False, mcdo=False):
        ...
        if not self.was_initialized:
            ...
            if training:
                ...
                # self.data_aug_params['patch_size_for_spatialtransform'] = np.asarray([128, 128, 128])
    ...
    def initialize_network(self):
        ...
        self.network = P_Net(patch_size=self.patch_size, in_channels=self.num_input_channels, out_channels=32, num_classes=self.num_classes, conv_op=conv_op)
    ...
    def get_basic_generators(self):
        self.load_dataset()
        self.do_split()
        # self.patch_size = np.asarray([128, 128, 128])
