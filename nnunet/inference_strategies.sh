...
# 3d_fullres 1 fold; fast; step 2; 3pp; 6 export; all_in_gpu | model=nnUNetTrainerV2_2_noMirror__nnUNetPlans_customClip
...
# 3d_fullres 2 folds; fast; step 2; 3pp; 6 export; all_in_gpu | model=nnUNetTrainerV2_2_noMirror__nnUNetPlans_customClip
...
# 3d_fullres 3 folds; fast; step 2; 3pp; 6 export; all_in_gpu | model=nnUNetTrainerV2_2_noMirror__nnUNetPlans_customClip
...
# 3d_fullres 3 folds; fast; step 1.5; 3pp; 6 export; all_in_gpu | model=nnUNetTrainerV2_2_noMirror__nnUNetPlans_customClip
...
# 3d_fullres 5 folds; fast; step 2; 3pp; 6 export; all_in_gpu | model=nnUNetTrainerV2_2_noMirror__nnUNetPlans_customClip
...
# 3d_fullres 1 fold; fast; step 2; 3pp; 6 export; all_in_gpu | model=nnUNetTrainerV2_2
...
# 3d_fullres 2 folds; fast; step 2; 3pp; 6 export; all_in_gpu | model=nnUNetTrainerV2_2
...
# 3d_fullres 3 folds; fast; step 2; 3pp; 6 export; all_in_gpu | model=nnUNetTrainerV2_2
...
# 3d_fullres 5 folds; fast; step 2; 3pp; 6 export; all_in_gpu | model=nnUNetTrainerV2_2
...
# Task52 speed tests
# 3d_lowres 5 folds; fast; step 2; 3pp; 6 export; all_in_gpu | model=nnUNetTrainerV2_2_noMirror
