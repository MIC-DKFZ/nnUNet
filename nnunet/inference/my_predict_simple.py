...
def inference(fold_and_device, input_folder, output_folder, trainer_class_name, output_probabilities, task_name):
    folds, device = fold_and_device
    output_folder = output_folder + "fold_" + str(folds)
    folds = [folds]

    model = "3d_fullres"
    disable_tta = True
    num_threads_preprocessing = 1  # 6
    ...
    predict_from_folder(model_folder_name, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
                        ...
                        overwrite_existing=overwrite_existing, mode=mode, overwrite_all_in_gpu=all_in_gpu,
                        mixed_precision=not False,
                        step_size=step_size, checkpoint_name=chk, output_probabilities=output_probabilities, uncertainty_tta=uncertainty_tta, mcdo=mcdo)
