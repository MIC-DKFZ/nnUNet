...
#     parser.add_argument("-d", "--device", help="Set the device", required=False, default=0)
...
if __name__ == "__main__":
    ...
    # main()
    parser = argparse.ArgumentParser()
    parser.add_argument("-network", required=False, default="3d_fullres")
    parser.add_argument("-network_trainer", required=False, default="nnUNetTrainerV2_P_Net")
    parser.add_argument("-task", required=False, default="001", help="can be task name or task id")
    parser.add_argument("-fold", required=False, default="1", help='0, 1, ..., 5 or \'all\'')
    parser.add_argument("-val", "--validation_only", help="use this if you want to only run the validation",
                        action="store_true")
    parser.add_argument("-c", "--continue_training", help="use this if you want to continue a training",
                        action="store_true")
