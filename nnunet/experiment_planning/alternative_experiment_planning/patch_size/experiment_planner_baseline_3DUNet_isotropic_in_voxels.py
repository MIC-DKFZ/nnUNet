...
if __name__ == "__main__":
    tasks = subdirs(cropped_output_dir, prefix="Task", join=False)[:10]
    tasks = tasks# + ["Task24_Promise", "Task27_ACDC"]
    for t in tasks:
        #t = 'Task10_Colon'
        threads = 30

        crop(t, override=False, num_threads=threads)
        ...
        exp_planner.run_preprocessing((threads, threads))
        #    except:
        #        pass
