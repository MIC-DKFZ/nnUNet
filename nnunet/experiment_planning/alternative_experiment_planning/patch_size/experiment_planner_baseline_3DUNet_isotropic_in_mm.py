    ...
    def plan_experiment(self):
        ...
        def get_stage(current_spacing, original_spacing, original_shape, num_cases,
            ...
            while here > ref:
                ...
                largest_axis = np.argsort(current_patch_in_mm)[-1]
                ...
                new_shp[largest_axis] -= shape_must_be_divisible_by[largest_axis]
            ...
            do_dummy_2D_data_aug = (max(input_patch_size) / input_patch_size[0]) > 2
...
if __name__ == "__main__":
    tasks = subdirs(cropped_output_dir, prefix="Task", join=False)
    ...
    for t in tasks:
        try:
            ...
            exp_planner = ExperimentPlannerIso(cropped_out_dir, preprocessing_output_dir_this_task)
