...
from nnunet.experiment_planning.configuration import FEATUREMAP_MIN_EDGE_LENGTH_BOTTLENECK, \
    ...
    HOW_MUCH_OF_A_PATIENT_MUST_THE_NETWORK_SEE_AT_STAGE0, RESAMPLING_SEPARATE_Z_ANISOTROPY_THRESHOLD
...
if __name__ == "__main__":
    ...
    for t in tasks:
        try:
            ...
            exp_planner = ExperimentPlannerPoolBasedOnSpacing(cropped_out_dir, preprocessing_output_dir_this_task)
