...
if __name__ == "__main__":
    # convert to nifti.gz
    dirs = ['/media/fabian/My Book/MedicalDecathlon/Task35_ISBILesionSegmentation/imagesTr',
            '/media/fabian/My Book/MedicalDecathlon/Task35_ISBILesionSegmentation/imagesTs',
            '/media/fabian/My Book/MedicalDecathlon/Task35_ISBILesionSegmentation/labelsTr']
    ...
    train_folder = '/media/fabian/My Book/MedicalDecathlon/Task35_ISBILesionSegmentation/imagesTr'
    ...
    labels_folder = '/media/fabian/My Book/MedicalDecathlon/Task35_ISBILesionSegmentation/labelsTr'
    ...
    for patientid in range(1, 20):
        for t in range(1, 20):
            if isfile(join("/media/fabian/My Book/MedicalDecathlon/Task35_ISBILesionSegmentation/imagesTs",
                           "case__%02.0d__%02.0d_0000.nii.gz" % (patientid, t))):
                ts_files.append("case__%02.0d__%02.0d.nii.gz" % (patientid, t))


    out_base = '/media/fabian/My Book/MedicalDecathlon/Task35_ISBILesionSegmentation/'
    ...
    json_dict['numTest'] = len(subfiles('/media/fabian/My Book/MedicalDecathlon/Task35_ISBILesionSegmentation/imagesTs')) // 4
    ...
    case_identifiers = np.unique([i[:-12] for i in subfiles("/media/fabian/My Book/MedicalDecathlon/MedicalDecathlon_raw_splitted/Task35_ISBILesionSegmentation/imagesTr", suffix='.nii.gz', join=False)])
    ...
    maybe_mkdir_p("/media/fabian/nnunet/Task35_ISBILesionSegmentation")
    save_pickle(splits, join("/media/fabian/nnunet/Task35_ISBILesionSegmentation", "splits_final.pkl"))
