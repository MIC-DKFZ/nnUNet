...
class SegmentationNetwork(NeuralNetwork):
    ...
    def predict_3D(self, x: np.ndarray, do_mirroring: bool, mirror_axes: Tuple[int] = (0, 1, 2),
        ...
        """
        It is the responsibility of the user to make sure the network is in the proper mode (eval for inference!)
        :param x:
        :param do_mirroring:
        :param mirror_axes:
    ...
    def predict_2D(self, x, do_mirroring: bool, mirror_axes: tuple = (0, 1, 2), use_sliding_window: bool = False,
                   ...
                   use_gaussian: bool = False, pad_border_mode: str = "constant",
                   pad_kwargs: dict = None, all_in_gpu: bool = False, return_softmax: bool = True,
                   verbose: bool = True) -> Tuple[np.ndarray, np.ndarray]:
        """
        It is the responsibility of the user to make sure the network is in the proper mode (eval for inference!)
