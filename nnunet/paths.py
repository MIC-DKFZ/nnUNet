...
base = '/kaggle/working/nnUNet/DataSet/nnUnet_raw'  #os.environ['nnUNet_raw_data_base'] if "nnUNet_raw_data_base" in os.environ.keys() else None
preprocessing_output_dir = '/kaggle/working/nnUNet/DataSet/nnUnet_preprocessed'  #os.environ['nnUNet_preprocessed'] if "nnUNet_preprocessed" in os.environ.keys() else None
network_training_output_dir_base = '/kaggle/working/nnUNet/DataSet/nnUnet_trained_models'  #os.path.join(os.environ['RESULTS_FOLDER']) if "RESULTS_FOLDER" in os.environ.keys() else None
