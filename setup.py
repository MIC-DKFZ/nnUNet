...
setup(name='nnunetv2',
      ...
      entry_points={
          'console_scripts': [
              ...
              'nnUNetv2_plan_experiment = nnunetv2.experiment_planning.plan_and_preprocess_entrypoints:preprocess_entry',
              'nnUNetv2_preprocess = nnunetv2.experiment_planning.plan_and_preprocess_entrypoints:preprocess',
              'nnUNetv2_train = nnunetv2.run.run_training:nnUNet_train_from_args',
