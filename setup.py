...
setup(name='nnunetv2',
      ...
      entry_points={
          'console_scripts': [
              'nnUNet_convert_decathlon_dataset = nnunet.experiment_planning.nnUNet_convert_decathlon_dataset:main',
              ...
              'nnUNet_plot_dataset_pngs = nnunet.utilities.overlay_plots:entry_point_generate_overlay',
          ],
      },
