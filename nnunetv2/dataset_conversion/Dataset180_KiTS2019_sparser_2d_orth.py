...
from nnunetv2.dataset_conversion.Dataset177_KiTS2019_sparse_2d_orth import \
    load_set_all_but_every_nth_slice_to_ignore_save2
...
if __name__ == '__main__':
    ...
    dataset_name = 'Dataset180_KiTS2019_sparser_2d_orth'
    ...
    print(compute_labeled_fractions_folder(join(nnUNet_raw, maybe_convert_to_dataset_name(64), 'labelsTr'),
                                           join(nnUNet_raw, maybe_convert_to_dataset_name(180), 'labelsTr'),
                                            labels=(0, 1, 2),
