...
def ensemble_folders(list_of_input_folders: List[str],
    ...
    shutil.copyfile(join(list_of_input_folders[0], 'dataset.json'), join(output_folder, 'dataset.json'))
...
def ensemble_crossvalidations(list_of_trained_model_folders: List[str],
    ...
    shutil.copyfile(join(list_of_trained_model_folders[0], 'plans.json'), join(output_folder, 'plans.json'))
    shutil.copyfile(join(list_of_trained_model_folders[0], 'dataset.json'), join(output_folder, 'dataset.json'))
