...
class nnUNetTrainerPyTorchDataloader(nnUNetTrainer):
    ...
    def get_tr_and_val_datasets(self):
        ...
        dataset_tr = nnUNetPytorchDataset(
            self.preprocessed_dataset_folder,
            initial_patch_size,
            self.configuration_manager.patch_size,
            self.label_manager,
        ...
        dataset_val = nnUNetPytorchDataset(
            self.preprocessed_dataset_folder,
            self.configuration_manager.patch_size,
            self.configuration_manager.patch_size,
            self.label_manager,
        ...
        for epoch in range(self.current_epoch, self.num_epochs):
            ...
            for batch_id in range(self.num_iterations_per_epoch):
                ...
                try:
                    ...
                    train_batch_tuple = next(iterator)
                train_batch = {
                    "data": train_batch_tuple[0],
                    "target": train_batch_tuple[1],
                }
            ...
            with torch.no_grad():
                ...
                for batch_id in range(self.num_val_iterations_per_epoch):
                    ...
                    try:
                        ...
                        val_batch_tuple = next(iterator)
                    val_batch = {
                        "data": val_batch_tuple[0],
                        "target": val_batch_tuple[1],
                    }
